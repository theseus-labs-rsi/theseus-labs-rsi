...
export const researchItems: ResearchItem[] = [
  ...
  },
  {
    ...
    summary: 'A dedicated slot for the next Theseus Lab result. Replace this record with its title, abstract and links when ready.',
    status: 'placeholder',
  },
  {
    slug: 'project-03',
    ...
    summary: 'A flexible space for short research notes, work in progress and news from the lab.',
    status: 'placeholder',
  },
]
